 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://exception.handling.ws.javax.learnings.com/", wsdlLocation = "http://localhost:8081/SoapJavaxWS/ws/MyCalculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://exception.handling.ws.javax.learnings.com/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/SoapJavaxWS/ws/MyCalculator?wsdl");
     ...
     * 
     * @return
     *     returns CalculatorFunctions
     */
    @WebEndpoint(name = "CalculatorImplPort")
    public CalculatorFunctions getCalculatorImplPort() {
        return super.getPort(new QName("http://exception.handling.ws.javax.learnings.com/", "CalculatorImplPort"), CalculatorFunctions.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculatorImplPort")
    public CalculatorFunctions getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://exception.handling.ws.javax.learnings.com/", "CalculatorImplPort"), CalculatorFunctions.class, features);
    }
